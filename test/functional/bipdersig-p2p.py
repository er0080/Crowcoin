...
class BIP66Test(CrowTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # crowd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and crowd produces more specific reject
            # reasons.
