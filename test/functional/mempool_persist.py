...
By default, crowd will dump mempool on shutdown and
...
class MempoolPersistTest(CrowTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give crowd a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent crowd from writing mempool.dat to disk. Verify that `savemempool` fails")
