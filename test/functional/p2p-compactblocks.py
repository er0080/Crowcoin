...
# TestNode: A peer we use to send messages to crowd, and store responses.
...
class CompactBlocksTest(CrowTestFramework):
    ...
    # This test actually causes crowd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that crowd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for crowd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # crowd will not send blocktxn responses for blocks whose height is
