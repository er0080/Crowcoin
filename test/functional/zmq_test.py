...
from test_framework.test_framework import CrowTestFramework, SkipTest
...
class ZMQTest (CrowTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that crow has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("crowd has not been built with zmq enabled.")
