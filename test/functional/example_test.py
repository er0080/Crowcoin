...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the CrowTestFramework
    pass

class ExampleTest(CrowTestFramework):
    # Each functional test is a subclass of the CrowTestFramework class.
    ...
    def custom_method(self):
        ...
        CrowTestFramework class so other tests can use it."""
