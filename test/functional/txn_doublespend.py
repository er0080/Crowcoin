...
class TxnMallTest(CrowTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 CROW:
        ...
        # First: use raw transaction API to send 1240 CROW to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 CROW coin each
        ...
        # Node0's balance should be starting balance, plus 50CROW for another
        ...
        # Node0's total balance should be starting balance, plus 100CROW for 
