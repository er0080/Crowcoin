...
Also test that nodes that send unsupported service bits to crowd are disconnected
...
class CNodeNoVersionBan(CLazyNode):
    ...
    # NOTE: implementation-specific check here. Remove if crowd ban behavior changes
    def on_open(self, conn):
        super().on_open(conn)
...
class P2PLeakTest(CrowTestFramework):
