Crow Core version *0.15.0.1* is now available from:

  <https://crow.org/bin/crow-core-0.15.0.1/>

and

  <https://crowcoin.org/bin/crow-core-0.15.0.1/>
...
installer (on Windows) or just copy over `/Applications/Crow-Qt` (on Mac)
or `crowd`/`crow-qt` (on Linux).
...
Crow Core is extensively tested on multiple operating systems using
the Linux kernel, macOS 10.8+, and Windows Vista and later. Windows XP is not supported.

Crow Core should also work on most other Unix-like systems but is not
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/crow/).
