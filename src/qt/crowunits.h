...
#ifndef CROW_QT_CROWUNITS_H
#define CROW_QT_CROWUNITS_H
...
/** Crow unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class CrowUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit CrowUnits(QObject *parent);

    /** Crow units.
      @note Source: https://en.crow.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        CROW,
...
typedef CrowUnits::Unit CrowUnit;

#endif // CROW_QT_CROWUNITS_H
