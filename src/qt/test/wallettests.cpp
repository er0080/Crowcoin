...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<CrowAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_crow-qt -platform xcb      # Linux
//     src/qt/test/test_crow-qt -platform windows  # Windows
//     src/qt/test/test_crow-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = CrowUnits::formatWithUnit(unit, balance, false, CrowUnits::separatorAlways);
    ...
    // Amount input
    CrowAmountField* amountInput = receiveCoinsDialog.findChild<CrowAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: crow:")) != -1);
