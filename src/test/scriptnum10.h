...
#ifndef CROW_TEST_SCRIPTNUM10_H
#define CROW_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Crow Core 0.10.0, for cross-comparison.
 */
public:
